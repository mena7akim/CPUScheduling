...
public class AddProcessFrame extends JFrame {
    public AddProcessFrame(DefaultTableModel tableModel){
        ...
        addButton.addActionListener(e -> {
            if(processNameField.getText().equals("") || arrivalTimeField.getText().equals("") || burstTimeField.getText().equals("") || priorityField.getText().equals("")){
            ...
            tableModel.addRow(new Object[]{processName, arrivalTime, burstTime, priority});
            this.dispose();
        });
